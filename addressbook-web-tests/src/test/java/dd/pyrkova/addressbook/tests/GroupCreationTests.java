...
public class GroupCreationTests extends TestBase {
  ...
  public Iterator<Object[]> validGroupsFromXml() throws IOException {
    BufferedReader reader = new BufferedReader(new FileReader(new File("src/test/resouces/groups.xml")));
    String xml ="";
  ...
  public Iterator<Object[]> validGroupsFromJson() throws IOException {
    BufferedReader reader = new BufferedReader(new FileReader(new File("src/test/resouces/groups.json")));
    String json ="";
    String line = reader.readLine();
    while (line != null){
      json += line;
